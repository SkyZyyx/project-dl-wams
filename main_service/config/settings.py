...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "dev-main-secret")
...
ALLOWED_HOSTS += [
    host
    for host in ("testserver", "mainservice", "userservice", "productservice", "orderservice", "searchservice")
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "postgres_main"),
